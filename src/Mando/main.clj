...
(defonce program-data-dirpath (or
                               (some-> (System/getenv "Mando_PATH")
                                       (.replaceFirst "^~" (System/getProperty "user.home")))
                               (.getCanonicalPath ^File (clojure.java.io/file (System/getProperty "user.home") "Mando"))))

(defonce state-file-filepath (.getCanonicalPath ^File (clojure.java.io/file program-data-dirpath "Mando.edn")))
...
(def ^:const jframe-title "any idea what they gonna do with it?")
